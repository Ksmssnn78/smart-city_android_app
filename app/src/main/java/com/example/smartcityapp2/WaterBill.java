...
public class WaterBill extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        billno = (EditText)findViewById(R.id.w_billno);
        consumer = (EditText)findViewById(R.id.w_consumer);
        amnt = (EditText)findViewById(R.id.w_amount);
        w_pay = (Button) findViewById(R.id.w_pay);
        user = getIntent().getStringExtra("w_user");
        records = new Bill_Records();

        reff = FirebaseDatabase.getInstance().getReference().child("Member").child(user);
        reff2 = FirebaseDatabase.getInstance().getReference().child("WaterBill");
        ...
        w_pay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(WaterBill.this, "Hold For Proceed", Toast.LENGTH_SHORT).show();
            }
        });

        w_pay.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
                ...
                if( !(b_no.isEmpty()) || !(c_no.isEmpty()) || !(temp_amnt.isEmpty()))
                {
                            ...
                            if(snapshot.exists()){
                                ...
                                if(amnt2<=database_amnt)
                                {
                                    ...
                                    if( !(name.isEmpty()) || !(mail.isEmpty()) || !(phone.isEmpty())){
                                        ...
                                        Intent intent = new Intent(WaterBill.this, Confirm_Box_2.class);
                                        intent.putExtra("confirm2",user);
                                        startActivity(intent);

                                    }else{
                                        Toast.makeText(WaterBill.this,"something went wrong in database!", Toast.LENGTH_SHORT).show();
                                    }
                                }else{
                                    Toast.makeText(WaterBill.this,"You don't have enough cash!", Toast.LENGTH_SHORT).show();
                                }
                            }
                        }
                        @Override
                    ...
                    Toast.makeText(WaterBill.this,"input all data!", Toast.LENGTH_SHORT).show();
                }
